...
function Basket() {
    ...
    const onClearBasket = () => {
        if (window.confirm('Are you sure you want to empty the cart?')) dispatch(clearBasket())
    }

    const onRemoveItem = id => {
        if (window.confirm('Do you really want to delete?')) dispatch(removeBasketItem(id))
    }
        ...
        <div className="container container--cart">
            {totalCount ?
                <div className="cart">
                    <div className="cart__top">
                        ...
                        <div className="cart__clear">
                            ...
                            <span onClick={onClearBasket}>CLEAR CART</span>
                        </div>
                    </div>
                    ...
                    <div className="cart__bottom">
                        <div className="cart__bottom-details">
                            <span style={{ color: 'white' }}> Total burgers: <b>{totalCount} pcs.</b> </span>
                            <span style={{ color: 'white' }}> Order price: <b>{totalPrice} $</b> </span>
                        </div>
                ...
                <div className="cart cart--empty">
                    <h2 style={{ color: 'darkorange' }}>Cart is empty <i>😕</i></h2>
                    <p style={{ color: 'white' }}>
                        Most likely you haven't ordered a burger yet.<br />
                        To order a burger, go to the main page.
                    </p>
                    <img src={shoppingCart} alt="Empty cart" />
